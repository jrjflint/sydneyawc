...
- `winemaking.html` - beginner-friendly educational overview for home winemaking basics, process, equipment, fermentation, and bottling safety.
...
- `assets/`
  ...
  - `js/mead-recipe-builder.js` renders the metric mead calculator interactions and shareable URL parameters, backed by `js/mead-recipe-builder-calculations.mjs`.
